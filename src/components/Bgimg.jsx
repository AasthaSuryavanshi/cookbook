...
const Bgimg = () => {
    return (
        <div className="w-full h-[70vh] mt-20 border border-zinc-100 relative">
            <img className="object-cover w-full h-full" src="../src/utils/bg-img-homeb.jpg" alt="" />
            <div className="w-[38vw] h-[59vh] bg-cyan-50 text-center flex flex-col gap-7 py-16 items-center px-10 rounded absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
                ...
                <p className="mb-2 text-xl font-medium tracking-wide">Lorem, ipsum dolor sit amet consectetur rum similique quisquam itaque molestiae a?</p>
